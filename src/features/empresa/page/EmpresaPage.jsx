                            ...
                            <tbody>
                                {lista.map(empresa => (
                                    <tr key={empresa.id}>
                                        ...
                                        <td style={{ textAlign: 'center' }}>{formatarData(empresa.nomeFantasia)}</td>
                                        <td style={{ textAlign: 'center' }}>{formatarData(empresa.fone)}</td>
                                        <td style={{ textAlign: 'center' }}>{formatarData(empresa.foneAlternativo)}</td>
